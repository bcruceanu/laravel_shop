    ...
    <div class="container p-2 m-1">
        <div class="row">
            <div class="col-md-4 col-sm-12 bg-light d-flex justify-content-center">
                <img class="m-1" src="{{ $product->picture_url }}" alt="web-creation"
            ...
            <div class="col-md-8 col-sm-12 bg-light d-flex flex-column">
                ...
                <div class="row justify-content-between">
                    @can('create', $product)
                    <a href="{{ route('products.edit', $product->id) }}" class="btn btn-outline-success m-1"
                        style="min-width: 100px; max-height: 40px">Edit</a>
                    @endcan
                    <a onclick="addToCart({{ $product }})" class="button btn-outline-success m-1"
                        style="max-width: 200px; align-self: end; font-size: unset" href="">Add to cart
